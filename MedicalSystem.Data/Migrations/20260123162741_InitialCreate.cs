    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialistExaminations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecialistExaminations_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpecialistExaminations_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialistExaminations_DoctorId",
                table: "SpecialistExaminations",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecialistExaminations_PatientId",
                table: "SpecialistExaminations",
                column: "PatientId");
        }
